  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        <div>
          <h2 className="text-3xl font-bold bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent">Horarios</h2>
          <p className="text-neutral-500 mt-1">Gestión de horas de salida y llegada estandarizadas.</p>
        </div>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-neutral-200 dark:border-neutral-800 text-sm font-semibold text-neutral-500">
              ...
              <th className="py-4 px-4">Hora de Salida</th>
              <th className="py-4 px-4">Hora de Llegada</th>
