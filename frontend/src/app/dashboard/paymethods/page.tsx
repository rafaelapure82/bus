  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        <div>
          <h2 className="text-3xl font-bold bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent">Métodos de Pago</h2>
          <p className="text-neutral-500 mt-1">Gestión de pasarelas y configuraciones de cobro.</p>
        </div>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-neutral-200 dark:border-neutral-800 text-sm font-semibold text-neutral-500">
              ...
              <th className="py-4 px-4">Nombre (Ej: PayPal, Stripe)</th>
