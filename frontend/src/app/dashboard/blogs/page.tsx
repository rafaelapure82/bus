  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        <div>
          <h2 className="text-3xl font-bold bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent">Blog</h2>
          <p className="text-neutral-500 mt-1">Gestión de artículos y noticias del portal.</p>
        </div>
